    ...
    def GPR_hyperparams_opt(self):
        if (self.GP_param.count_GPR == 1):
            ...
            if (np.max(temp1)<1.0 or np.max(temp2)<1.0):
                ...
                l_opt = np.max([np.min([self.GP_param.hyp_l_GPR[0],0.5]),1e-1])
                ...
                self.GP_param.hyp_q_GPR[0] = np.max([np.min([self.GP_param.hyp_q_GPR[0],1]),1e-2])
        ...
        if (self.GP_param.count_GPR == 2):
            ...
            if (np.max(temp1)<1.0 or np.max(temp2)<1.0):
                ...
                l_opt = np.max([np.min([self.GP_param.hyp_l_GPR[1],0.5]),1e-1])
                ...
                self.GP_param.hyp_q_GPR[1] = np.max([np.min([self.GP_param.hyp_q_GPR[1],1]),1e-2])
